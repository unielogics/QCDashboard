...
function DealAnalyzerSection() {
  const features: { title: string; body: string }[] = [
    {
      title: "Profit, calculated to perfection",
      body: "Purchase, rehab, contingency, carry, closing and selling costs are modeled exactly — so projected net profit and margin are real numbers, not back-of-napkin guesses.",
    },
    {
      title: "Your true banking power for the deal",
      body: "Instantly see the loan you can actually get, your real cash to close, and how much more you can pull before the 75% ARV safety line — financed-construction vs. self-funded, side by side.",
    },
    {
      title: "Matched to the right capital",
      body: "Every deal is scored against live lender programs and a configurable closing-cost table — you see the program that fits and what it costs, before you ever make an offer.",
    },
    {
      title: "No credit pull. No delays.",
      body: "The analyzer runs entirely off the deal numbers. A soft credit check is optional and borrower-initiated — it never gates the math or stalls the deal.",
    },
  ];
  return (
    <section
      id="deal-analyzer"
      className="qc-footer-bg"
      style={{ padding: "64px 22px", borderTop: "1px solid rgba(255,255,255,0.06)" }}
    >
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <span
            style={{
              ...
              background: "rgba(33,211,199,0.07)",
              color: "#21D3C7",
              fontSize: 12,
              fontWeight: 700,
          ...
          >
            Know the deal — and your borrowing power — before you make the offer.
          </h2>
          <p
            style={{
              marginTop: 14,
          ...
          >
            The Deal Analyzer is the engine underneath every file: it calculates
            profit to perfection and shows the exact financing power available for
            the deal — instantly, with no credit pull and nothing slowing you down.
          </p>
        </div>
