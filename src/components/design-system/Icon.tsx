...
const ICON_PATHS: Record<string, string> = {
  ...
  note:      "M5 4h11l3 3v13a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1zM8 10h8M8 14h6",
  ...
  eyeOff:    "M3 3l18 18M10.6 10.6a2 2 0 002.8 2.8M9.9 4.2A10.8 10.8 0 0112 4c6.5 0 10 8 10 8a18.4 18.4 0 01-3.1 4.1M6.6 6.6C3.6 8.6 2 12 2 12s3.5 8 10 8a9.6 9.6 0 004.2-1",
