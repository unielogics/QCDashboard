...
export default function MfaBanner() {
  ...
  return (
    ...
    >
      <div style={{ fontWeight: 650, color: V.ink, fontSize: 14 }}>
        Two-step verification is not set up on this account.
      </div>
      <div style={{ fontSize: 13, color: V.ink3, marginTop: 3, lineHeight: 1.55 }}>
        It takes about a minute with an authenticator app, and it is required for
        everyone with access to client files.{" "}
        <Link href="/account/security" style={{ color: V.brand, fontWeight: 600 }}>
          Set it up now
        </Link>
        .
      </div>
