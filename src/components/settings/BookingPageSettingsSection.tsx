...
function defaultBookingSettings(): UserBookingSettings {
  return {
    ...
    precall_messages: {},
    precall_default_variant: "main_street",
    precall_allowed_variants: ["dealer", "real_estate", "main_street", "mca_refinance"],
    precall_allow_vertical_choice: true,
    inherit_firm_policy: false,
